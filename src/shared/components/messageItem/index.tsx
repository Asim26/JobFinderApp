    ...
    return (
        <TouchableOpacity
            ...
            <View style={styles.profileDetailsContainer}>
                ...
                <Text style={[styles.contentTitle,{fontSize: RF(12),fontFamily: FONTS.Milliard,color: props?.unread ? colors.BLACK : colors.GRAY,marginBottom:RF(3)}]}>{props?.message}</Text>
            </View>
