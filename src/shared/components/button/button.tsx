...
const Button = (props: any) => {
    ...
    return (
        <TouchableOpacity
            disabled={isDisabled}
            onPress={onPress !== undefined ? onPress : onPressDefault} style={[touchableStyle, { backgroundColor: bgColor, height: height, width: width, borderRadius: borderRadius || RF(22.5), borderWidth: borderWidth, borderColor: borderColor }]}>
